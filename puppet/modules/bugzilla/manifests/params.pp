...
class bugzilla::params (
  ...
  $admin_email               = hiera('bugzilla::params::admin_email', 'admin@example.com')
  $admin_password            = hiera('bugzilla::params::admin_password', 'admin123')
  $admin_realname            = hiera('bugzilla::params::admin_realname', 'admin')
