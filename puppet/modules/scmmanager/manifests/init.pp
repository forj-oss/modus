...
inherits scmmanager::params {
  ...
  if ! defined(File[$scmmanager::params::scmmanager_target_dir]) {
    file { $scmmanager::params::scmmanager_target_dir:
      ensure => directory,
      owner  => root,
      group  => root,
    }
  ...
  class { 'scmmanager::package':
    require => File[$scmmanager::params::scmmanager_target_dir],
  }
  class { 'scmmanager::config':
    require => Class['scmmanager::package'],
  }
}
