  ...
  class modus_openldap::openldap_package (

    $openldap_package_version   =   $modus_openldap::openldap_params::openldap_package_version,
  ) inherits modus_openldap::openldap_params {
